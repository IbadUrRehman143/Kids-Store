...
function Navbar() {
    ...
    const navItems = (
        <>
            ...
            <li>
                <Link to="/book"> Total Category</Link>
            </li>
            <li>
            ...
            <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4  fixed top-0 left-0 right-0 z-50 ${
                ...
                <div className="navbar bg-base-100">
                    <div className="navbar-start ">
                        ...
                        <Link className="font-bold text-xl cursor-pointer">KIDS <span className='text-secondary hover:text-success'>STORE</span></Link>
                    </div>
                    <div className='navbar-end space-x-4'>
                        ...
                        <div className="">
                            <Link to="" className="bg-secondary text-white hover:bg-success duration-300 py-2 px-4 rounded-md cursor-pointer " onClick={()=>document.getElementById("my_modal_3").showModal()}>Login</Link>
                            <Login/>
                        </div>
                    </div>
                </div>
